...
Meteor.publish("notesPublish", function () { return notes.find({owner: Meteor.userId()}, {fields:{lastUpdated: 1, lastUpdatedWho: 1, sharedWith: 1, note: 1, title: 1, tags: 1, stared: 1}}); });
